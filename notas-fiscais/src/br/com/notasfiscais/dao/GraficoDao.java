...
public class GraficoDao implements Serializable {
	...
	return manager
		.createQuery(
			"select new br.com.notasfiscais.modelo.QuantidadePorProduto(sum(i.quantidade), i.produto) "
				+ " from Item i group by i.produto",
			QuantidadePorProduto.class).getResultList();
    }
}